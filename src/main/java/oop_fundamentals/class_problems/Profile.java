...
public class Profile {
    public static void main(String[] args) {
        // --- Test 1: classifyAccess ---
        System.out.println("--- Test 1: classifyAccess ---");
        System.out.println(AccessRuleEngine.classifyAccess("private", "SAME_CLASS"));                            // ALLOWED
        System.out.println(AccessRuleEngine.classifyAccess("default", "DIFFERENT_PACKAGE"));                     // DENIED
        ...
        // --- Test 2: summarizeBatch ---
        System.out.println("--- Test 2: summarizeBatch ---");
        String[][] attempts = {
        ...
        // --- Test 3: describeContext ---
        System.out.println("--- Test 3: describeContext ---");
        System.out.println(AccessRuleEngine.describeContext("SUBCLASS_DIFFERENT_PACKAGE_PARENT_TYPE")); // Subclass Different Package Parent Type
        System.out.println(AccessRuleEngine.describeContext("SAME_PACKAGE"));                            // Same Package
        System.out.println();

        // --- Test 4: PatientRecord Construction Validation ---
